        ...
        siloBuilder
            ...
            .AddAzureEventHubStreams("Default", configurator =>
            {
                configurator.ConfigureEventHub(builder => builder.Configure(options =>
                {
                    ...
                    options.ConsumerGroup = "inventory-service";
                    options.Path = "inventory-events";
                }));
                configurator.UseAzureTableCheckpointer(builder => builder.Configure(options =>
                {
                    ...
                    options.TableName = "InventoryCheckpoints";
                }));
            })
            .UseDashboard(options => 
            {
...
public class CurrentUserService : ICurrentUserService
{
    ...
    public IEnumerable<string> Permissions => new[] { "inventory.read", "inventory.write" };
